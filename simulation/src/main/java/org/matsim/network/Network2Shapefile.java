...
public class Network2Shapefile {
    //    输入的耦合网络 XML 文件路径
    private static String inputFilePath = "D:\\Luan\\2025-09\\MATSim\\guangzhoubaseline\\network_with_transit.xml";
    //    道路网络 XML 文件路径
    private static String roadNetPath = "D:\\Luan\\2025-09\\MATSim\\guangzhoubaseline\\decouplingNetworks\\roadNetwork";
    //    轨道网络 XML 文件路径
    private static String raiNetPath = "D:\\Luan\\2025-09\\MATSim\\guangzhoubaseline\\decouplingNetworks\\railNetwork";
    //    地面公交网络 XML 文件路径
    private static String busNetPath = "D:\\Luan\\2025-09\\MATSim\\guangzhoubaseline\\decouplingNetworks\\busNetwork";
    //    输入的 xml 文件的坐标系统，同时也是输出的 shapefile 文件的坐标系统
    private static String defaultCRS = "EPSG:32649";

    //    输出的耦合网络 shapefile 文件路径 outputAsLines.shp -----> 道路路段用 lines 表示
    private static String outputCouNetsPath1 = "D:\\Luan\\2025-09\\MATSim\\guangzhoubaseline\\coupled Networks\\Lines\\lines_epsg32650.shp";
    //    输出的耦合网络 shapefile 文件路径 outputAsPolygons.shp  -------> 道路路段用 polygons 表示，路段通过自由流速度，车道数，通行能力推算
    private static String outputCouNetsPath2 = "D:\\Luan\\2025-09\\MATSim\\guangzhoubaseline\\coupled Networks\\Polygons\\Polygons_epsg32650.shp";

    //    输出的轨道网络 shapefile 文件路径 outputAsLines.shp
    private static String outputRailNetsPath1 = "D:\\Luan\\2025-09\\MATSim\\guangzhoubaseline\\metro Network\\Lines\\lines_epsg32650.shp";
    //    输出的轨道网络 shapefile 文件路径 outputAsPolygons.shp
    private static String outputRailNetsPath2 = "D:\\Luan\\2025-09\\MATSim\\guangzhoubaseline\\metro Network\\Polygons\\Polygons_epsg32650.shp";

    //    输出的bus网络 shapefile 文件路径 outputAsLines.shp
    private static String outputBusNetsPath1 = "D:\\Luan\\2025-09\\MATSim\\guangzhoubaseline\\bus Network\\Lines\\lines_epsg32650.shp";
    //    输出的bus网络 shapefile 文件路径 outputAsPolygons.shp
    private static String outputBusNetsPath2 = "D:\\Luan\\2025-09\\MATSim\\guangzhoubaseline\\bus Network\\Polygons\\Polygons_epsg32650.shp";

    //    输出的道路网络 shapefile 文件路径 outputAsLines.shp
    private static String outputRoadNetsPath1 = "D:\\Luan\\2025-09\\MATSim\\guangzhoubaseline\\road Network\\Lines\\lines_epsg32650.shp";
    //    输出的道路网络 shapefile 文件路径 outputAsPolygons.shp
    private static String outputRoadNetsPath2 = "D:\\Luan\\2025-09\\MATSim\\guangzhoubaseline\\road Network\\Polygons\\Polygons_epsg32650.shp";
...
//        first step: decoupling the multilayer interconnected networks
        ...
        createDirectoryIfNotExists(new File(raiNetPath).getParent());
        createDirectoryIfNotExists(new File(busNetPath).getParent());
        createDirectoryIfNotExists(new File(roadNetPath).getParent());
//        second step: write subnetworks to folder "decouplingNetworks" separately
        ...
        // 确保输出目录存在
        createDirectoryIfNotExists(new File(outputCouNetsPath1).getParent());
        createDirectoryIfNotExists(new File(outputCouNetsPath2).getParent());
        createDirectoryIfNotExists(new File(outputRailNetsPath1).getParent());
        createDirectoryIfNotExists(new File(outputRailNetsPath2).getParent());
        createDirectoryIfNotExists(new File(outputBusNetsPath1).getParent());
        createDirectoryIfNotExists(new File(outputBusNetsPath2).getParent());
        createDirectoryIfNotExists(new File(outputRoadNetsPath1).getParent());
        createDirectoryIfNotExists(new File(outputRoadNetsPath2).getParent());
